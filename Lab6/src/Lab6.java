...
public class Lab6 extends GLJPanel implements GLEventListener  {
    ...
    public void Pyramid(GL2 gl2, int numVerticles, int radius){
        float x = 0, z = 0;
        double angle = 0;
        ...
        for (int i = 1; i<= numVerticles; i++){
            ...
            gl2.glMaterialfv(GL2.GL_FRONT, GL2.GL_AMBIENT_AND_DIFFUSE, materials[i], i-4);
            gl2.glVertex3f(x, -2.0f, z);

            gl2.glMaterialfv(GL2.GL_FRONT, GL2.GL_AMBIENT_AND_DIFFUSE, materials[i], i-6 );
            gl2.glVertex3f(0, 7.0f, 0);
